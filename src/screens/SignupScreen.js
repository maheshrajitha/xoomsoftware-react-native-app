...
import { SafeAreaView, TouchableWithoutFeedback, Keyboard , View, Dimensions } from 'react-native';
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <SafeAreaView style={[MainStyleSheet.flexBox1, MainStyleSheet.fullSizeContainer, MainStyleSheet.alignItemsCenter, MainStyleSheet.justifyContentCenter]}>
                    ...
                    <View style={[MainStyleSheet.alignItemsCenter, MainStyleSheet.justifyContentCenter, MainStyleSheet.halfHeightContainer]}>
                        <StyledRoundTextField placeholder={'Firstname'} transparent/>
                        <StyledRoundTextField placeholder={'Lastname'} transparent/>
                        <StyledRoundTextField placeholder={'Emai Address'} transparent isEmail/>
                        <StyledRoundTextField placeholder={'Password'} transparent isPassword/>
                        <StyledRoundTextField placeholder={'Re-type Password'} transparent isPassword />
                        <StyledButton text={'Signup'} buttonColor={SECONDARY_COLOR} marginTop={Dimensions.get('screen').height / 30}/>
                    </View>
                </SafeAreaView>
